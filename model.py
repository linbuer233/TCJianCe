...
class Connet(nn.Module):
    ...
    def __init__(self):
        ...
        #
        self.conv1 = nn.Conv2d(in_channels=10, out_channels=8, kernel_size=3)
    ...
    def forward(self, t):
        ...
        # print("1juan:", t.shape)
        t = F.relu(t)
        t = F.avg_pool2d(t, kernel_size=4, stride=1)
        # print("1pool:", t.shape)
        #
        t = self.conv2(t)
        # print("2juan:", t.shape)
        t = F.relu(t)
        t = F.avg_pool2d(t, kernel_size=3, stride=2)
        # print("2pool:", t.shape)
